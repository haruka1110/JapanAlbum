...
<script>
        ...
        function showOverlay(imageUrl, photoId) {
            ...
            deleteButton.href = "<%=request.getContextPath()%>/Ibarakidelete?id=" + photoId;
        }
...
<body>
	...
	<h3>写真を追加する</h3>
	<form action="<%=request.getContextPath()%>/Ibarakiadd" method="get">
		<input type="submit" value="写真を追加する">
	</form>
	<form action="<%=request.getContextPath()%>/Ibaraki" method="get">
    ...
    for (Photo photo : photoList) {
        ...
        // 関東地方の県のみ表示する条件を追加
        if (photo.getLocation().equals("茨城県")) {
    %>
    <li>
        <div>
	...
	<div id="overlay" onclick="hideOverlay()">
		<img src="" alt="写真">
		<form action="<%=request.getContextPath()%>/Ibarakidelete" method="post">
